...
s.t. X = A + E
     ...
     S = W * X
%}
function [A,E,W,Y1,Y2,Y3,fun1All,fun2All,fun3All,result,obj1,obj2,obj3,obj4,zsl_unseen_predict_label] = LSA(trX,S,params,tu_attr,att,Xtu,Xts,tu_ind,ts_ind,Ytu,Yts)
%% =====参数设置，初始化========================
X = trX;
